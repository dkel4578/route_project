...
import { fetchProductClassificationPage } from "../redux/slices/ProductClassificationSlice.js";
...
import ProductClassificationModal from "../modals/ProductClassificationModal"; // ✅ 모달 import
...
const ProductClassificationPage = () => {
  ...
  const { loading, error, data } = useSelector(
    (state) => state.productClassification
  );
  ...
  useEffect(() => {
    dispatch(fetchProductClassificationPage());
  }, [dispatch]);
